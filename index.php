...
<body>
    ...
    <div class="hoja-vida">
        <aside class="col-izq">
            ...
            <hr class="separador">
            <p class="nota-final">Hoja de vida realizada con esfuerzo, sudor y casi lagrimas</p>
        </aside>
        ...
        <main class="col-der">
            ...
            <section class="caja-blanca">
                ...
                <div class="contenido-vacio">Esperando información...</div>
            </section>
            ...
            <section class="caja-blanca">
                <div class="titulo-seccion"><i class="fas fa-code"></i> Productos Laborales y Académicos</div>
                <div class="contenido-vacio">Esperando información...</div>
            </section>
